<template>
  <div>
    <H_modal v-model="show" class="H_datagridPopup" offset="50%" no-persistent :movable="true">
      <div ref="draggableContainer" class="H_datagridPopup__container shadow-4">
...
import H_modal from "../../../../Components/popup/H_modal.vue";
import H_icon from "../../../../Components/H_icon.vue";
import H_tabs from "../../../../Components/navigation/H_tabs.vue";
import H_tab from "../../../../Components/navigation/H_tab.vue";
