...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/introduction/main.css_with_Tailwind': RouteRecordInfo<'/introduction/main.css_with_Tailwind', '/introduction/main/css_with_Tailwind', Record<never, never>, Record<never, never>>,
